...
const SideNav = () => {
    return (
        <div className="h-screen absolute inset-y-0 left-0 bg-[#d9d9d9] p-4 gap-2">
            <button className="flex flex-row text-[#858585] gap-2 hover:text-[#f9f9f9] hover:bg-[#858585] p-2 rounded mt-14">
                <HomeIcon className="h-6 w-6"/> Overview
            </button>
            <button className="flex flex-row text-[#858585] gap-2 hover:text-[#f9f9f9] hover:bg-[#858585] p-2 rounded mt-2">
